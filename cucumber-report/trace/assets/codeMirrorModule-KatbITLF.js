import { V as ku, W as wu } from "./inspectorTab-DdpLd2bb.js";
var ho = { exports: {} },
  ha;
function It() {
  return (
...
`,
          ...
          function Ha(e, t, n, r, i, o, l) {
            if (t) {
              var a = e.splitSpaces ? Ra(t, e.trailingSpace) : t,
...
`
              ...
              if (x == s) {
                ...
                for (var G = [], ee = void 0, me = 0; me < r.length; ++me) {
                  ...
                  if (Fe.type == "bookmark" && pe.from == s && Fe.widgetNode)
                    ...
                    Fe.collapsed && (!U || wi(U.marker, Fe) < 0) && (U = pe);
          ...
          function qr(e, t) {
            ...
            r && !r.text
              ...
              : r &&
                r.changes &&
                (Io(e, r, n, Pi(e)), (e.curOp.forceUpdate = !0)),
              r || (r = es(e, t));
            var i = Ro(r, t, n);
            return {
              line: t,
            ...
            return (
              t.cache.hasOwnProperty(o)
                ...
                : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                  t.hasHeights || ($a(e, t.view, t.rect), (t.hasHeights = !0)),
                  (l = rs(e, t, n, r)),
                  l.bogus || (t.cache[o] = l)),
              {
                left: l.left,
              ...
              for (var h = 0; h < 4; h++) {
                ...
                if (
                  (b && N < 9 && l == 0 && a == i.coverEnd - i.coverStart
                    ...
                    : (u = ts(w(o, l, a).getClientRects(), r)),
                  u.left || u.right || l == 0)
                )
                  break;
                (a = l), (l = l - 1), (s = "right");
              }
              b && N < 11 && (u = ns(e.display.measure, u));
            } else {
              l > 0 && (s = r = "right");
              var v;
          ...
          function jt(e, t, n, r, i, o) {
            ...
            function l(M, E) {
              ...
              return (
                E ? (R.left = R.right) : (R.right = R.left), Yn(e, r, R, n)
              );
            }
          ...
          function Ni(e, t, n) {
            ...
            var i = g(r, n),
              o = r.first + r.size - 1;
            if (i > o)
              return Ei(r.first + r.size - 1, ce(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = ce(r, i); ; ) {
              var a = is(e, l, i, t, n),
          ...
          function is(e, t, n, r, i) {
            ...
            if (h) {
              var v = (e.options.lineWrapping ? ls : os)(e, t, n, o, h, r, i);
              (u = v.level != 1),
                (a = u ? v.from : v.to - 1),
                (s = u ? v.to : v.from - 1);
            }
          ...
          function yn(e, t) {
            Math.abs(e.doc.scrollTop - t) < 2 ||
              (I || Ki(e, { top: t }), ol(e, t, !0), I && Ki(e), kn(e, 100));
          }
          function ol(e, t, n) {
            (t = Math.max(
              0,
          ...
          function ps(e) {
            for (var t = e.ops, n = 0; n < t.length; n++) gs(t[n]);
            for (var r = 0; r < t.length; r++) vs(t[r]);
            for (var i = 0; i < t.length; i++) ms(t[i]);
            for (var o = 0; o < t.length; o++) ys(t[o]);
            for (var l = 0; l < t.length; l++) xs(t[l]);
          }
          function gs(e) {
            var t = e.cm,
              n = t.display;
          ...
          function ji(e, t) {
            ...
            return (
              ...
              Ts(e, n.updateLineNumbers, t.dims),
              ...
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                if (
                  (n &&
                    ...
                    (n = {
                      top: Math.min(
                        e.doc.height + Di(e.display) - Mi(e),
                        n.top,
                      ),
                    }),
          ...
          function pt(e, t, n) {
            li(e, t, n), Es(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n);
          }
          function li(e, t, n) {
          ...
          function Ol(e, t) {
            if (
              ...
              var n = Yi(e, t);
              kl(e, t, n, e.cm ? e.cm.curOp.id : NaN), Tn(e, t, n, ki(e, t));
              var r = [];
              vr(e, function (i, o) {
                !o &&
                  oe(r, i.history) == -1 &&
          ...
          Cn.prototype = {
            ...
            removeInner: function (e, t) {
              for (var n = e, r = e + t; n < r; ++n) {
                var i = this.lines[n];
                (this.height -= i.height), za(i), ot(i, "delete");
              }
            ...
            if (!this.explicitlyCleared) {
              ...
              for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed
                  ...
                  (l.markedSpans = Da(l.markedSpans, a)),
                  a.from == null &&
                    this.collapsed &&
                    !cr(this.doc, l) &&
                    e &&
          ...
          function Vr(e, t, n, r, i) {
            if (r && r.shared) return Bs(e, t, n, r, i);
          ...
          (kt.prototype = F(Dn.prototype, {
            ...
            replaceSelections: at(function (e, t, n) {
              ...
              for (
                var a = t && t != "end" && Ds(this, r, t), s = r.length - 1;
                s >= 0;
                s--
              )
                Jr(this, r[s]);
            ...
            unlinkDoc: function (e) {
              if ((e instanceof Ge && (e = e.doc), this.linked))
                for (var t = 0; t < this.linked.length; ++t) {
                  var n = this.linked[t];
                  if (n.doc == e) {
                    this.linked.splice(t, 1), e.unlinkDoc(this), _s(Hl(this));
                    break;
                  }
                }
          ...
          function Ys(e) {
            ...
            for (var n in e)
              if (e.hasOwnProperty(n)) {
                ...
                for (var i = Pe(n.split(" "), Xs), o = 0; o < i.length; o++) {
                  var l = void 0,
                    a = void 0;
                  o == i.length - 1
                    ? ((a = i.join(" ")), (l = r))
                  ...
                  !(r && nu(t, i, r, o, e)) &&
                    (i == 1
                      ...
                      : i == 2
                        ...
                        : i == 3 &&
                          (fe ? t.display.input.onContextMenu(e) : _i(t)));
              }
            }
          }
...
`) &&
          ...
          function pu(e) {
            ...
            (e.prototype = {
                ...
                for (
                  ...
                  if (a.empty())
                    ...
                    s.ch == 0 &&
                      i.length == k.length &&
                      k[l].from().ch > 0 &&
                      $i(this.doc, l, new He(s, k[l].to()), Ve);
                  }
                }
              }),
              ...
              coordsChar: function (r, i) {
                return (r = Zo(this, r, i || "page")), Ni(this, r.left, r.top);
              },
          ...
          function uo(e, t, n, r, i) {
            ...
            function h(Q) {
              ...
              } else i ? (G = Zs(e.cm, a, t, n)) : (G = to(a, t, n));
              if (G == null)
...
`));
            ...
            (je.prototype.pollContent = function () {
              ...
              if (
                ...
                return !1;
              for (
                var v = e.doc.splitLines(vu(e, a, h, l, u)),
            ...
            function Ve(f, g, A) {
              ...
              return ze.hasOwnProperty(f)
                ...
                : f == "function"
                  ? d(Pt, L)
                  : f == "class" || (_ && g == "interface")
                    ? ((D.marked = "keyword"), d(j("form"), yi, ue))
                    : f == "keyword c" || f == "async"
                      ? d(A ? Ne : oe)
                      : f == "("
                        ? d(j(")"), ct, Te(")"), ue, L)
      ...
      return {
        ...
        indent: function (ae, Se) {
          ...
          if (
            ...
            for (
              ;
              he.type == "statement" && y.dontIndentStatements.test(he.info);
    ...
    Ee("text/x-kotlin", {
      ...
      hooks: {
        ...
        indent: function (m, y, P, le) {
          ...
          if (y.align && y.type == "}")
            return (
              y.indented + (m.context.type == (P || "").charAt(0) ? 0 : le)
            );
        },
      },
      ...
      function (De, I) {
        ...
        function de(p, c) {
          ...
          var oe =
            ...
            Ne =
              (c.list === !1 || ue || xe) && c.indentation <= Le && p.match(_),
            qe = null;
          if (
            c.indentationDiff >= 4 &&
          ...
          if (
            ...
            if (Ne)
              return p.skipToEnd(), (c.hr = !0), (c.thisLine.hr = !0), b.hr;
              ...
              c.push(b.formatting + "-" + p.formatting[Y]),
                ...
                p.formatting[Y] === "quote" &&
                  (!I.maxBlockquoteDepth || I.maxBlockquoteDepth >= p.quote
                    ? c.push(
                        b.formatting + "-" + p.formatting[Y] + "-" + p.quote,
                      )
                    : c.push("error"));
          }
        ...
        function D(p, c) {
          ...
          if (j === "]" && c.imageAltText) {
            ...
            var Ne = H(c);
            return (
              (c.imageAltText = !1), (c.image = !1), (c.inline = c.f = d), Ne
            );
          }
          if (j === "[" && !c.image)
            return (
